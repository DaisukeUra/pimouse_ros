...
class BuzzerTest(unittest.TestCase):
    ...
    def test_music(self):
        ...
        self.assertFalse(goal.freqs == self.device_values,
                         "stop is requested but return true")
    ...
    def test_node_exist(self):
        ...
        self.assertIn('/buzzer', nodes, "nodedoes not exist")
    ...
    def test_put_value(self):
        ...
        with open("/dev/rtbuzzer0", "r") as f:
            data = f.readline()
            self.assertEqual(
                data, "1234\n", "calue does not written to rtbuzzer0")


if __name__ == '__main__':
    time.sleep(3)
    rospy.init_node('travis_test_buzzer')
    rostest.rosrun('pimouose_ros', 'travis_test_buzzer', BuzzerTest)
